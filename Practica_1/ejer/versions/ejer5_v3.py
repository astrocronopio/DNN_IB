...
def ejer5():
    ...
    plt.xlabel("Épocas")
    plt.yscale('log')
    plt.plot(model_SVM.error_loss,color="blue", alpha=0.6, label="Support Vector Machine")
    plt.plot(model_SMC.error_loss,color="red", alpha=0.6, label="SoftMax Classifier")
    ...
    plt.xlabel("Épocas")
    plt.ylabel('acc')
    plt.plot(100*np.ones_like(model_SMC.error_acc), color='black', alpha=0.5, ls='--')
    plt.plot(model_SVM.error_acc,color="blue",alpha=0.6, label="Support Vector Machine")
    plt.plot(model_SMC.error_acc,color="red", alpha=0.6, label="SoftMax Classifier")
